		...
		<nav className="flex justify-between mx-auto  items-center px-4 md:px-12 py-8" data-aos="zoom-in">
			...
			<div className=" hidden nav-items md:flex items-center w-[65%]">
				<ul className="hidden md:flex text-white w-[70%]">
					<li className='px-6'><a href="#">Features</a></li>
					<li className='px-6'><a href="#">Company</a></li>
					<li className='px-6'><a href="#">Blog</a></li>
				</ul>
				<button className="hidden md:block w-[20%] h-[62px] font-semibold ml-auto text-white">Sign in</button>
				<button className="hidden md:block w-[20%] h-[62px] font-semibold ml-auto text-white">Sign up</button>
			</div>
